...
Add unit tests; run pytest.

## Risks
- Deleting existing logic in scoped_tokens could exceed deletion limits; we only add an import.
- TTL constant hardcoded; future changes need update.
