...
## Verification
All three tests pass and TTL constant is present in the source.

## Risks
- Deleting or drastically changing existing scaffold code could violate the 0.7*deletion guard; we only appended an import line.
- Ensure the new validator does not interfere with existing token acquisition logic.
