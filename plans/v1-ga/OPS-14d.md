...
## Verification
Tests pass via `pytest -q tests/auth/test_ttl_validation.py`.

## Risks
- Ensure new TTL validator does not interfere with existing token flow.
- Deleting or modifying existing validator logic is avoided; new module introduced only.
