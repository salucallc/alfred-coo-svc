...
- Added `ttl_validator.py` with `validate_iat` implementation.
- Added unit tests `tests/auth/test_ttl_validation.py` asserting status codes and error body.
- Updated CI to run the new tests; they all pass.
