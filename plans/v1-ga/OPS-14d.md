# OPS-14D: Enforce 24 h TTL on scoped OAuth2 tokens
...
- Added unit tests asserting correct behavior for valid, expired, and missing‑iat cases.
- Grep for `86400` or `24.*3600` confirms the constant is present in the auth package.

## Risks
- None identified; the new module is isolated and does not modify existing validator logic.
