...
- Manually grep for the TTL constant to confirm presence.

## Risks
- Deleting existing code in `scoped_tokens.py` could break other flows; only additive imports are added.
- Ensure exception handling does not interfere with other token pathways.
