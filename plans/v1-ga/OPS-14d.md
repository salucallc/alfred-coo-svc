...
- Added ttl_validator with 86400 seconds TTL constant.
- New tests cover valid, expired, and missing iat cases using freezegun.
- `pytest -q` passes with exit code 0.

## Risks
- Introducing a new module may require import updates elsewhere; currently isolated.
- Tight TTL enforcement could affect existing clients using longer-lived tokens.
