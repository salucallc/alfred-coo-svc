...
## Risks
- Deleting or overwriting existing logic in `scoped_tokens.py` beyond the minimal import could break other OPS‑14 scaffolding. The change adds a new helper without altering existing behavior.
- Tests rely on `freezegun`; ensure it is available in the test environment.
