...
Added unit tests using pytest and monkeypatch to simulate current time. All tests pass.

## Risks
- Introduces new module; ensure import paths are correct.
- No existing integration points; future code must call `validate_iat`.
