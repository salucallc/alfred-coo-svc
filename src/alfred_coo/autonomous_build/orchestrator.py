...
class AutonomousBuildOrchestrator:
    ...
    async def _respawn_child_with_fixes(
        ...
        body = (
            ...
            f"replacement).\n"
            f"- [ ] The replacement body MUST also carry a "
            f"`## Addresses Prior Feedback` section that summarises "
            f"which review points you addressed and how. Gate E "
            f"rejects fix-round update_pr calls without this heading "
            f"(accepted variants: `## Prior Feedback`, `## Fixes From "
            f"Previous`, `## Response to Review`, `## Review Response`, "
            f"`## Changes in Response`).\n"
            f"\n"
            f"## Review feedback\n"
